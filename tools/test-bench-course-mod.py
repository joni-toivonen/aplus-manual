...
def modify_default_courses():
    ...
    if created:
        instance2.set_teachers([teacher.userprofile])
        instance2.save()
    ...
    exercise = BaseExercise.objects.get(
        ...
        url='m01_introduction_07_questionnaires_questionnaire_text_demo_2',
        #order=1,
    )
    ...
    for i in range(2, 100):
        ...
        for i in range(300):
            ...
            new_submission.submitters.set([student.userprofile])
